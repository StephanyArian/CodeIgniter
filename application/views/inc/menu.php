    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
            <div class="position-relative">
                ...
                $imgSrc = empty($foto) ? base_url('uploads/estudiantes/perfil.jpg') : base_url('uploads/estudiantes/' . $foto);
                ?>
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="<?php echo base_url('index.php/Usuario/lista_usuarios#'); ?>" class="nav-item nav-link <?php echo is_active('Usuario') ? 'active' : ''; ?>"><i class="fa fa-table me-2"></i>Usuarios</a>
            <a href="<?php echo base_url('index.php/Precios_controller/index#'); ?>" class="nav-item nav-link <?php echo is_active('Precios_controller') ? 'active' : ''; ?>"><i class="fa fa-keyboard me-2"></i>Gestionar Precios</a>
            <a href="<?php echo base_url('index.php/Reportes_controller/index#'); ?>" class="nav-item nav-link <?php echo is_active('Reportes_controller') ? 'active' : ''; ?>"><i class="far fa-file-alt me-2"></i>Reportes</a>
         </div>
    </nav>
</div>
